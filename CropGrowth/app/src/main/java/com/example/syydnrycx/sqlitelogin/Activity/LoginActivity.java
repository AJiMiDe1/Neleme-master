...
import com.example.syydnrycx.sqlitelogin.Class.SmsObserver;
...
public class LoginActivity extends Activity implements View.OnClickListener{
    ...
    private EditText edit_cord= null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initViews();
        sms_verification();
        edit_cord = (EditText) findViewById(R.id.ed_code);

    }

    private void initViews() {

        bt_login=(Button) findViewById(R.id.btn_edit);
